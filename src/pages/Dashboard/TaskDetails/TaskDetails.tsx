...
const TaskDetails: React.FC<TaskDetailsProps> = ({
  ...
  return (
    <div
      className={
        variant === "overlay"
          ? "p-6 w-full flex flex-col gap-5"
          : "p-5 w-full min-h-screen flex flex-col gap-5 border border-gray-400 rounded-xl"
      }
    >
      {/* Go Back */}
      <span
        className="self-end font-medium text-sm cursor-pointer hover:underline"
        onClick={onClose}
      >
        Go Back
      </span>
